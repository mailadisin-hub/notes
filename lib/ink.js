...
/**
 * A whiteboard: the same page, seventy-five page-widths across and down, opened
 * in the middle. Not literally endless - a number has to stop somewhere - but
 * at writing size it is thousands of pages of room in every direction.
 */
export const BOARD = 60000;
/** How far above the middle a board's opening view starts. */
export const BOARD_START_TOP = 300;
