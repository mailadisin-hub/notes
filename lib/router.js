...
/* A wide window can hold the list beside an open note, but a note you opened
   to write on wants the whole screen, so this is off unless it is asked for.
   Settings turns it on; app.js reads the setting before the panes are built. */
